  ...
  return (
    <>
      ...
      <main className="mt-[10vh] p-4">
        {/* Centered Content */}
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-800">Welcome to Cricket Betting Market</h1>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800">Cricket Betting Overview</h2>
            <p className="text-gray-500 mt-2">
              Explore the most exciting cricket match-ups and place your bets using secure, decentralized transactions.
            </p>
          </div>
          <div className="bg-gradient-to-br from-black via-purple-700 to-purple-400 p-[2px] rounded-lg max-w-3xl mx-auto">
            <div className="bg-gray-950 text-white rounded-lg p-6">
              <h3 className="text-3xl font-bold text-center text-purple-300 mb-4">
                IPL 2024 Final: Mumbai Indians vs Kolkata Knight Riders
              </h3>
              <div className="flex justify-around items-center mt-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold">Mumbai Indians</h4>
                    <p className="text-sm text-gray-400">Best odds: 1.65</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  <div className="w-16 h-16 bg-purple-600 rounded-full flex justify-center items-center">
                    <span className="text-white text-xl font-bold">KKR</span>
                  </div>
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold">Kolkata Knight Riders</h4>
        ...
        {/* Smaller Cricket Betting Grids */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-4 sm:px-6 lg:px-8">
          {[
            "Delhi Capitals vs Rajasthan Royals",
            "Royal Challengers Bangalore vs Chennai Super Kings",
            "Punjab Kings vs Sunrisers Hyderabad",
            ...
            >
              ...
              <div className="bg-gray-950 text-white rounded-lg p-4">
                ...
                <div className="flex justify-between items-center mt-4">
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-purple-600 rounded-full flex justify-center items-center">
                      <span className="text-white text-md font-semibold">DC</span>
                    </div>
                    <div className="ml-3">
                      <h3 className="text-md font-semibold">Delhi Capitals</h3>
                      <p className="text-sm text-gray-400">Best odds: 1.80</p>
                    </div>
                  </div>
                  <div className="text-md text-gray-400 font-bold">VS</div>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-purple-600 rounded-full flex justify-center items-center">
                      <span className="text-white text-md font-semibold">RR</span>
                    </div>
                    <div className="ml-3">
                      <h3 className="text-md font-semibold">Rajasthan Royals</h3>
                      <p className="text-sm text-gray-400">Best odds: 2.05</p>
                    </div>
                  </div>
                </div>
      ...
      {/* Footer Section */}
      <footer className="bg-gradient-to-t from-gray-950 to-gray-800 text-gray-400 py-6 text-center">
        <p className="text-sm">
          © {new Date().getFullYear()} AI Market. All rights reserved.
        </p>
        <p className="text-sm mt-2">
